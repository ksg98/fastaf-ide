...
export const DEFAULT_BINDINGS: Record<ActionName, string> = {
	...
	"open-path": "Cmd+Alt+O",
	// VSCode parity: ⌥⌘C / ⇧⌥⌘C copy the active file's absolute / relative path
	"copy-file-path": "Cmd+Alt+C",
	"copy-relative-file-path": "Cmd+Shift+Alt+C",
	"open-secondary-window": "",
	"command-overview": "",
	"ai-triage": "",
