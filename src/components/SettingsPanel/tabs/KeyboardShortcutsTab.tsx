	...
	return [
		...
		},
		{
			...
			shortcuts: [
				...
				{
					action: "toggle-multiview",
					keys: keyFor("toggle-multiview"),
					description: "Multiview (all terminals grid)",
				},
		...
		},
		{
			...
			shortcuts: [
				...
				{ action: "copy-file-path", keys: keyFor("copy-file-path"), description: "Copy active file path" },
				{
					action: "copy-relative-file-path",
					keys: keyFor("copy-relative-file-path"),
					description: "Copy active file relative path",
				},
