...
1. Create a directory: `~/.config/com.fastaf.ide/plugins/my-plugin/`
...
1. **Discovery** — Rust `list_user_plugins` scans `~/.config/com.fastaf.ide/plugins/` for `manifest.json` files
...
File: `~/.config/com.fastaf.ide/plugins/{id}/manifest.json`
...
host.openMarkdownFile("/Users/me/.config/com.fastaf.ide/plugins/my-plugin/README.md");
```
...
**Plugin data storage** is sandboxed to `~/.config/com.fastaf.ide/plugins/{id}/data/`. No capability required — every plugin can store its own data.
...
- macOS: `~/Library/Application Support/com.fastaf.ide/plugins/my-plugin/`
- Linux: `~/.config/com.fastaf.ide/plugins/my-plugin/`
- Windows: `%APPDATA%/com.fastaf.ide/plugins/my-plugin/`
