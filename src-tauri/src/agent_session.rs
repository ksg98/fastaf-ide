...
pub(crate) fn claude_projects_dir(config_dir_override: Option<&str>) -> Option<PathBuf> {
...
pub(crate) fn codex_sessions_dir(codex_home: Option<&str>) -> Option<PathBuf> {
...
pub(crate) fn extract_codex_uuid(name: &str) -> Option<String> {
